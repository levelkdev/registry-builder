...
contract MockTokenCuratedRegistry is TokenCuratedRegistry {
  ...
  constructor(ERC20 _token, uint _minStake, uint _applicationPeriod, IChallengeFactory _challengeFactory) public TokenCuratedRegistry(_token, _minStake, _applicationPeriod, _challengeFactory) { }
